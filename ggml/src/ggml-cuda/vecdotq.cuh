...
// [TAG_RDNA35_VDR_Q8_0] gfx1151 retires the K loop in half the trips with a wider
// vec-dot ratio; taken from myhacsint/llama.cpp production/strix-halo-qwen4exp-b10685.
#if defined(RDNA3_5)
