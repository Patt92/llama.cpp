...
// [TAG_MMVQ_Q8_1_CACHE] MoE decode re-quantizes the same activation row to q8_1 once per
// expert matmul. Cache the quantized buffer for the duration of one graph evaluation.
// Taken from myhacsint/llama.cpp production/strix-halo-qwen4exp-b10685.
...
struct ggml_backend_cuda_context {
    ...
    // [TAG_MMVQ_Q8_1_CACHE] see the key/entry types above.
