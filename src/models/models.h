...
class llm_graph_input_mem_hybrid_kpool;
...
struct llama_model_glm5next : public llama_model_base {
    ...
    struct graph : public llm_build_delta_net_base {
        ...
        ggml_tensor * build_hc_pre(ggml_tensor * x, ggml_tensor * hc_fn, ggml_tensor * hc_scale,
                ggml_tensor * hc_base, ggml_tensor ** post, ggml_tensor ** comb, int il);
        ggml_tensor * build_hc_post(ggml_tensor * x, ggml_tensor * residual,
        ...
        llm_graph_input_kpool * build_inp_kpool(llm_graph_input_mem_hybrid_kpool * inp_hyb);
