...
llama_context::llama_context(
    ...
    // [TAG_QWEN4EXP_SHARED_MTP] a shared qwen4exp draft borrows token_embd / output from its
    // target through ctx_other, the same way EAGLE3 and DFLASH drafts do. Follows PR 28243.
